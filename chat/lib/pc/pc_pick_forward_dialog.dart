...
class _PcPickForwardViewState extends State<PcPickForwardView> {
  final ForwardTargetController _controller =
      ForwardTargetController(multiSelect: true);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                  right: BorderSide(
                      color: context.colors.hairlineSoft, width: 0.5)),
            ),
            child: left,
          ),
  ...
  Widget _buildTargetSelection(BuildContext context) {
    return _buildShell(context,
        left: _buildTargetColumn(context), right: _buildForwardPanel(context));
  }
  ...
  Widget _buildForwardPanel(BuildContext context) {
    ...
    return _buildPanel(
      context,
      title:
          widget.oneByOne ? l10n.forwardSendSeparately : l10n.forwardSendMerged,
      ...
      action: FilledButton(
        onPressed: _controller.hasSelection
            ? () => widget.onSelected(selected, _comment)
            : null,
            ...
            child: Column(
              ...
              children: [
                ForwardMessagePreview(
                    messages: widget.messages, oneByOne: widget.oneByOne),
  ...
  Widget _buildCommentField(BuildContext context) {
    ...
    final underline = UnderlineInputBorder(
        borderSide: BorderSide(color: colors.hairlineSoft, width: 0.5));
    return TextField(

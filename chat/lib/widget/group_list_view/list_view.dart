...
class GroupListView extends StatefulWidget {
  ...
  final int defaultItemCountPerGroup;

  final SectionWidgetBuilder? groupExpandBuilder;
  ...
  const GroupListView({
    ...
    this.groupExpandBuilder,
    this.defaultItemCountPerGroup = 4,

...
void startSingleAvCall(BuildContext context, String userId, {required bool audioOnly}) {
  ...
  final conversation = Conversation(conversationType: ConversationType.Single, target: userId);
  if (isDesktopShell) {
    MainAvEngineKitProxy.instance.startCall(conversation, [userId], audioOnly);
  } else {
    avEngineKit.startCall(conversation, [userId], audioOnly);
  }
}

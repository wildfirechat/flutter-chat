        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              Center(child: Text("野火IM", style: TextStyle(fontSize: 24, color: colors.textPrimary, decoration: TextDecoration.none),),),
              Expanded(child: Container()),
              Center(child: Text("沟通如此简单!", style: TextStyle(fontSize: 18, color: colors.textSecondary, decoration: TextDecoration.none),),),

...
///评论类型
enum WFMCommentType { WFMComment_Comment_Type, WFMComment_Thumbup_Type }
...
typedef OnReceiveNewCommentCallback = void Function(
    MomentCommentMessageContent comment);
typedef OnReceiveMentionedFeedCallback = void Function(
    MomentFeedMessageContent feed);
...
class MomentClient {
  ///使用之前必须初始化
  static void init(OnReceiveNewCommentCallback newCommentCallback,
  ...
  static Future<Feed> postFeed(
    ...
    void Function(int errorCode)? errorCallback,
  }) async {
    return MomentClientImpl.instance.postFeed(type,
        text: text,
        medias: medias,
        toUsers: toUsers,
  ...
  static void deleteFeed(int feedId, MomentVoidSuccessCallback successCallback,
      FailureCallback errorCallback) {
    MomentClientImpl.instance
        .deleteFeed(feedId, successCallback, errorCallback);
  }

  ///批量获取朋友圈
  static void getFeeds(
      int fromIndex,
      int count,
      String? user,
      FeedsSuccessCallback feedsSuccessCallback,
      FailureCallback failureCallback) {
    MomentClientImpl.instance.getFeeds(
        fromIndex, count, user, feedsSuccessCallback, failureCallback);
  }

  ///获取单条朋友圈
  static void getFeed(int feedId, FeedSuccessCallback feedSuccessCallback,
      FailureCallback failureCallback) {
    MomentClientImpl.instance
        .getFeed(feedId, feedSuccessCallback, failureCallback);
  }
  ...
  static Future<Comment> postComment(
    ...
    return MomentClientImpl.instance.postComment(type, feedId,
  ...
  static void deleteComment(
      int commentId,
      int feedId,
      MomentVoidSuccessCallback successCallback,
      FailureCallback errorCallback) {
    MomentClientImpl.instance
        .deleteComment(commentId, feedId, successCallback, errorCallback);
  }
  ...
  static void getUserProfile(
      ProfilesSuccessCallback successCallback, FailureCallback failureCallback,
      {String? userId}) {
    MomentClientImpl.instance
        .getUserProfile(userId, successCallback, failureCallback);
  }

  ///更新朋友圈设置
  static void updateMyProfile(
      WFMUpdateUserProfileType updateProfileType,
      String? strValue,
      int? intValue,
      MomentVoidSuccessCallback successCallback,
      FailureCallback failureCallback) {
    MomentClientImpl.instance.updateMyProfile(updateProfileType, strValue,
        intValue, successCallback, failureCallback);
  }

  ///更新block和black的列表
  static void updateBlackOrBlockList(
      bool isBlock,
      List<String>? addList,
      List<String>? removeList,
      MomentVoidSuccessCallback successCallback,
      FailureCallback failureCallback) {
    MomentClientImpl.instance.updateBlackOrBlockList(
        isBlock, addList, removeList, successCallback, failureCallback);
  }
...
class MomentClientImpl {
  ...
  void getFeeds(
    ...
    Imclient.sendMomentsRequest(_pbPath('/feed/pull'), jsonEncode(dataDict),
        (String result) {
  ...
  void getFeed(int feedId, FeedSuccessCallback feedSuccessCallback,
    ...
    Imclient.sendMomentsRequest(_pbPath('/feed/pull_one'), data,
        (String result) {
      Map<String, dynamic> map = jsonDecode(result);
  ...
  void getUserProfile(String? userId, ProfilesSuccessCallback successCallback,
    ...
    _profileFromStore(targetUserId).then((cachedProfile) {
      ...
      Imclient.sendMomentsRequest(_path('/profiles/pull'), jsonEncode(dataDict),
          (String result) {
        Map<String, dynamic> map = jsonDecode(result);
